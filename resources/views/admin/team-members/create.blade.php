...
@section('content')
    <div class="container mx-auto px-4 py-8 max-w-3xl">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Ajouter un Membre d'Équipe</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.team-members.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Plus le nombre est petit, plus le membre apparaît en premier</p>
                    @error('order')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6 border-t pt-6">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Réseaux Sociaux (optionnels)</h3>
