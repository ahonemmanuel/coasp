{{-- resources/views/admin/allies/edit.blade.php --}}
@extends('layouts.dash')

@section('title', 'Modifier un Allié')
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-6">
                <i class="fas fa-edit mr-2 text-green-600"></i> Modifier l'Allié
            </h1>

            <form action="{{ route('admin.allies.update', $ally) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <img src="{{ asset('storage/' . $ally->logo) }}"
                             alt="{{ $ally->name }}"
                             class="h-24 w-auto object-contain border-2 border-gray-200 rounded p-2">
                        <div class="text-sm text-gray-500">
                            <p><i class="fas fa-info-circle mr-1"></i>Logo actuel de l'allié</p>
                            <p class="text-xs mt-1">Téléchargez un nouveau fichier pour le remplacer</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div id="imagePreview" class="mt-4 hidden">
                        <p class="text-sm font-medium text-gray-700 mb-2">Nouveau logo (aperçu) :</p>
                        <img src="" alt="Aperçu" class="max-h-32 rounded border-2 border-green-200">
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description"
                              ...
                              placeholder="Décrivez brièvement cet allié et sa mission...">{{ old('description', $ally->description) }}</textarea>
                    @error('description')
                    <p class="mt-1 text-sm text-red-600"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="url"
                               name="website"
                               id="website"
                               value="{{ old('website', $ally->website) }}"
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        <i class="fas fa-info-circle mr-1"></i>Plus le nombre est petit, plus l'allié apparaîtra en premier
                    </p>
                </div>
                ...
                <div class="mb-6">
                    <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                        <input type="checkbox"
                               ...
                               id="is_active"
                               value="1"
                               {{ old('is_active', $ally->is_active) ? 'checked' : '' }}
